...
export default function WhatsAppFloat() {
  return (
    <a
      ...
      className="wa-float"
      aria-label="Chat with DAO Marketing on WhatsApp"
      onClick={() => {
    ...
    >
      <span className="wa-float-label" aria-hidden>
        <em>Skip the form.</em>&nbsp;Slide in.
      </span>
      <span className="wa-float-circle" aria-hidden>
